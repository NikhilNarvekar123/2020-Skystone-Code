...
@Autonomous(group="Stone", name="BlueStoneFound")

public class BlueStoneFound extends AutoSystem implements AutoValues {

  public BlueStoneFound() {
  ...
  public void runOpMode() throws InterruptedException {
    ...
    while(opModeIsActive()) {
      ...
      if(stoneLocation.equals("BLUE_LEFT"))
        moveForward(43, LINEAR_SPEED_MAX, 1);
      else if(stoneLocation.equals("BLUE_CENTER"))
        moveForward(50, LINEAR_SPEED_MAX, 1);
      else
        moveForward(57, LINEAR_SPEED_MAX, 1);
      sleep(DEFAULT_METHOD_DELAY);
